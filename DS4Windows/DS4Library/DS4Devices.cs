...
namespace DS4Windows
{
    ...
    public class DS4Devices
    {
        ...
        private static VidPidInfo[] knownDevices =
        {
            ...
            new VidPidInfo(0x9886, 0x0025, "Astro C40"), // You should Disable Filter Driver to Use Astro C40 with DS4Windows. See Details: https://www.reddit.com/r/AstroGaming/comments/e5c5uk/psa_how_to_switch_c40_to_ps4_mode_on_windows_10/
